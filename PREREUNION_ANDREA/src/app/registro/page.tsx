    ...
    <main className="min-h-screen flex items-center justify-center p-4 py-12">
      ...
      >
        ...
        <div className="text-center mb-8">
          <Link href="/">
            <h1 className="font-display text-4xl gradient-text font-semibold tracking-wider">
              NUCLEA
            </h1>
          </Link>
          <p className="text-white/60 mt-2">Crea tu cuenta gratuita</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-white text-gray-900 font-medium rounded-xl flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors"
          >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-nuclea-bg text-white/40">o con email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-white/60 mb-2">Contrasena</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-sm text-white/60 mb-2">Confirmar contrasena</label>
              <div className="relative">
                <Lock size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40" />
                <input
                  type={showPassword ? 'text' : 'password'}
          ...
          <p className="text-center text-white/50 text-sm mt-6">
            ¿Ya tienes cuenta?{' '}
            <Link href="/login" className="text-nuclea-gold hover:text-nuclea-gold-light">
              Inicia sesion
            </Link>
          </p>
        </div>
