...
const firebaseConfig = {
  ...
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "nuclea-demo",
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "nuclea-demo.appspot.com",
