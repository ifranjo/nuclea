...
/* ------------------------------------------------------------------ */
/*  Decorative pills — more and better placed for premium feel        */
/* ------------------------------------------------------------------ */
const decorativePills = [
  ...
  // Additional pills for richer backdrop
...
/* ------------------------------------------------------------------ */
/*  Scattered mini-polaroids — tiny real photos floating behind the   */
/*  card list for a "memories everywhere" feel.                       */
/* ------------------------------------------------------------------ */
const bgPolaroids = [
...
export function P4CapsuleSelection() {
  ...
  return (
    <div className="h-[100dvh] flex flex-col bg-[radial-gradient(circle_at_50%_-8%,rgba(212,175,55,0.18),rgba(212,175,55,0.02)_36%,transparent_70%),linear-gradient(180deg,#F6F7FB_0%,#ECEEF4_100%)] relative overflow-hidden">
      ...
      {/* Background decorative layer — pills + polaroids */}
