...
| PRM-QUALITY-008 | domains/03_quality/Performance_Budget_Gate.md | quality | active | 2026-02-08 | REV-013 executed; PREREUNION FAIL (489KB bundle), POC WARN (9.4MB images); P0: image optimization + bundle analyzer setup |
