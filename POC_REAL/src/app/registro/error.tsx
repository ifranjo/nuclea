...
export default function RegistroError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <main className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="max-w-md w-full rounded-xl border border-nuclea-border bg-white p-6 text-center space-y-4">
        <h1 className="text-lg font-medium text-nuclea-text">Error en el registro</h1>
        <p className="text-sm text-nuclea-text-muted">
          Ocurrió un error inesperado. Puedes reintentar o ir a iniciar sesión.
        </p>
