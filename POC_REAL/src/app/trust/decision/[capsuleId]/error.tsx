...
export default function TrustDecisionError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <main className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="max-w-md w-full rounded-xl border border-nuclea-border bg-white p-6 text-center space-y-4">
        <h1 className="text-lg font-medium text-nuclea-text">Error en la decisión de confianza</h1>
