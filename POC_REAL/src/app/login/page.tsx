    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="login-email" className="block text-sm text-nuclea-text-secondary mb-1">Email</label>
            <input
              id="login-email"
              type="email"
              value={email}
          ...
          <div>
            <label htmlFor="login-password" className="block text-sm text-nuclea-text-secondary mb-1">Contraseña</label>
            <input
              id="login-password"
              type="password"
              value={password}
